...
DD_Net.summary()
Train= pickle.load(open("/media/DATA2/NAMPV/Hand_recognition/DD_NET/data/HOI4D_FPHAB_data_train_son.pkl", "rb"))
Test = pickle.load(open("/media/DATA2/NAMPV/Hand_recognition/DD_NET/data/HOI4D_FPHAB_data_test_son.pkl", "rb"))
...
plt.savefig("/media/DATA2/NAMPV/Hand_recognition/DD_NET/result/HOI4C/HOI4D_4C.png")

DD_Net.save("/media/DATA2/NAMPV/Hand_recognition/DD_NET/model/HOI4D_4C/HOI4D_4C.keras")
...
cm_analysis(y_true,y_pred, '/media/DATA2/NAMPV/Hand_recognition/DD_NET/result/HOI4C/HOI4D_4C.png', labels, ymap=None, figsize=(8,8))