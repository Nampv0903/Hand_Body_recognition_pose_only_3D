...
class Config():
    def __init__(self):
        ...
        self.clc_num = 37 # the number of coarse class
        self.feat_d = 210
        self.filters = 64
C = Config()
...
def cm_analysis(y_true, y_pred, filename, labels, ymap=None, figsize=(16,16)):
    """
...
DD_Net.summary()
Train= pickle.load(open("/home/nampv/NAMPV/nampv/H20_data/H2O_dataset_train.pkl", "rb"))
Test = pickle.load(open("/home/nampv/NAMPV/nampv/H20_data/H2O_dataset_test.pkl", "rb"))
...
plt.savefig('/home/nampv/NAMPV/nampv/DD_NET/output/loss_H2O_371.png')

DD_Net.save('/home/nampv/NAMPV/nampv/DD_NET/output/DD_Net_H2O_model1.keras')
...
cm_analysis(y_true,y_pred, '/home/nampv/NAMPV/nampv/DD_NET/output/H2O_371.png', labels, ymap=None, figsize=(16,16))